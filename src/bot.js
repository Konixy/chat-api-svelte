// @ts-ignore
import Discord, { Client, GatewayIntentBits, Partials, ActivityType } from "discord.js";
...
function sendEmbed(message, embedTitle, embedDescription, embedColorParam) {
    if(!message || !embedTitle && !embedDescription) return console.log('[ERROR] sendEmbed() function recieved invalid arguments')
